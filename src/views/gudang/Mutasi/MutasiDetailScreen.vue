    ...
    <template v-if="!mutationStore.isLoading">
            ...
            <div class="card-body">
              ...
              <div class="form-control">
                ...
                <div class="flex items-center">
                  <input
                    required
                    :value="$moment(mutationStore.dataDetailMasterMutation.data_date).format('L')"
                    type="input"
              ...
              <div class="card-body">
                ...
                <div class="flex mt-2 md:overflow-visible overflow-y-auto mb-5">
                  <table class="table table-compact w-full">
                    ...
                    <tbody>
                      <tr v-if="mutationStore.dataDetailMasterMutation.detail.length < 1">
                        <td colspan="4" class="text-center">
                          <span>Tidak ada data.</span>
                        </td>
                      </tr>
                      <tr v-else v-for="item in mutationStore.dataDetailMasterMutation.detail" :key="item">
      ...
      <template v-else>
        <div wire:loading class="top-0 left-0 right-0 bottom-0 overflow-hidden opacity-75 flex flex-col items-center justify-center">
          ...
          <p class="w-1/3 text-center text-white">Data yang di cari tidak tersedia</p>
        </div>
      </template>
    </template>
...
export default {
  ...
  created() {
    if (this.$route.params) {
      this.mutationStore.getDetailMasterMutation(this.$route.params.id, this.$route.params.type)
    }
  },
}
</script>
