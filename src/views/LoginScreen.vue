    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">Masuk ke Akun mu</h1>
    ...
    >
      <form class="p-10 bg-white rounded-xl drop-shadow-lg space-y-5" action="">
        ...
        <div class="flex flex-col space-y-2">
          <label class="text-sm font-light" for="username">User</label>
          <input
            v-model="authStore.username"
